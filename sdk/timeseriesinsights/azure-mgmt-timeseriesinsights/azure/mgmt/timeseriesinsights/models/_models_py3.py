...
class LongTermEnvironmentResourceProperties(ResourceProperties):
...
class ReferenceDataSetResourceProperties(ResourceProperties):
...
class StandardEnvironmentResourceProperties(ResourceProperties):
