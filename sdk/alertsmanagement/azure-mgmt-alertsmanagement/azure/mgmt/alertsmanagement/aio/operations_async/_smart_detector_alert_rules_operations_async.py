...
class SmartDetectorAlertRulesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.alertsmanagement.models.AlertRulesList
        ...
        async def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                error = self._deserialize(models.SmartDetectorErrorResponse, response)
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AlertRule or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.AlertRule or ~azure.mgmt.alertsmanagement.models.AlertRule
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AlertRule"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
