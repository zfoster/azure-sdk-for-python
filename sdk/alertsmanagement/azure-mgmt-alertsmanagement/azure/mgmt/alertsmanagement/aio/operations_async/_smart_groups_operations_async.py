...
class SmartGroupsOperations:
    ...
    def get_all(
     ...
     value is 'desc' for time fields and 'asc' for others.
        :type sort_order: str or ~azure.mgmt.alertsmanagement.models.Enum5
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SmartGroupsList or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.SmartGroupsList
