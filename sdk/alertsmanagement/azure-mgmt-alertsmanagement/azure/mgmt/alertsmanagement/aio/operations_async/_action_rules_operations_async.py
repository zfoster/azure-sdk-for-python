...
class ActionRulesOperations:
    ...
    def list_by_subscription(
     ...
     multiple scopes). The value should be an well constructed ARM id of the scope.
        ...
        :return: ActionRulesList or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.ActionRulesList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ActionRulesList"]
        ...
        async def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                error = self._deserialize(models.AlertsManagementErrorResponse, response)
    ...
    async def get_by_name(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ActionRule"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
        api_version = "2019-05-05-preview"
    ...
    async def update(
        ...
        **kwargs
        ...
        _action_rule_patch = models.PatchObject(tags=tags, status=status)
        api_version = "2019-05-05-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_action_rule_patch, 'PatchObject')
        body_content_kwargs['content'] = body_content
